    ...
    <div class="r-results">
        <div class="res-list mohe-cards" id="mohe-m-xxx" style="height:2000px;">
            <div class="mohe-card" style="margin-top: 200px;">
                <input id="test" type="text" value="" style="width:100%;height:50px;padding:0 2%;box-sizing: border-box;">
            </div>
        </div>
    </div>
</div>
...
_loader.add('handlebars', 'http://s4.qhimg.com/static/207b47645b84a5cd/handlebars-v1.3.0.js');
_loader.add("iScroll5","http://s8.qhimg.com/static/d4aff7543340dbc3/iscroll-probe.js");
_loader.add('listpick', 'http://s2.qhimg.com/static/3912f0d9f4504523/listpick.js');
_loader.add('data_city', 'http://s6.qhimg.com/!b5ea8e7a/m-city-v1.js');
_loader.use('widget,iScroll5,handlebars,listpick,data_city', function() {
    window.list = {};
